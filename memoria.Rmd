...
```
Análisis de dst_byte. Relevante
```{r EDA6, echo=TRUE}
...
p2 <- data %>% mutate(log10_urgent = urgent) %>%
...
p1 <- ggplot(data = data, aes(x = urgent, fill = class)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = class), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
...
p <- data %>% mutate(log10_su_attempted = su_attempted) %>%
...
p2 <- data %>% mutate(log10_num_outbound_cmds = num_outbound_cmds) %>%
...
p1 <- ggplot(data = data, aes(x = num_outbound_cmds, fill = class)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = class), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
...
p2 <- data %>% mutate(log10_serror_rate = serror_rate) %>%
...
p1 <- ggplot(data = data, aes(x = serror_rate, fill = class)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = class), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
...
p2 <- data %>% mutate(log10_srv_serror_rate = srv_serror_rate) %>%
...
p1 <- ggplot(data = data, aes(x = srv_serror_rate, fill = class)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = class), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
...
p2 <- data %>% mutate(log10_srv_rerror_rate = srv_rerror_rate) %>%
...
p1 <- ggplot(data = data, aes(x = srv_rerror_rate, fill = class)) +
      geom_density(alpha = 0.5) +
      scale_fill_manual(values = c("gray50", "orangered2")) +
      geom_rug(aes(color = class), alpha = 0.5) +
      scale_color_manual(values = c("gray50", "orangered2")) +
...
Análisis de dst_host_srv_diff_host_rate. Podría ser relevante.
```{r EDA43, echo=TRUE}
