...
```
Analizamos la variable su_attempted
```{r EDA2, echo=TRUE}
...
ggplot(Train_data, aes(su_attempted)) + geom_bar()+ ggtitle("x")
ggplot(Train_data, aes(su_attempted,fill=class))+ geom_bar()+ ggtitle("x")
```
